...
public class JdbcEventStore implements EventStore {
    ...
    @Override
    public void save(Object event) throws PayloadConvertException {
    ...
    private String toJson(Object event) throws PayloadConvertException {
        try {
    ...
    @Autowired
    public void dbcTemplate(JdbcTemplate jdbcTemplate) {
